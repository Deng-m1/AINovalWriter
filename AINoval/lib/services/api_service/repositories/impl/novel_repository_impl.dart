...
class NovelRepositoryImpl implements NovelRepository {
  ...
  Novel _convertToNovelModel(Map<String, dynamic> json) {
    ...
    if (novelData.containsKey('createdAt')) {
      createdAt = _parseDateTime(novelData['createdAt']);
    } else {
      createdAt = DateTime.now();
    }

    if (novelData.containsKey('updatedAt')) {
      updatedAt = _parseDateTime(novelData['updatedAt']);
    } else {
      updatedAt = DateTime.now();
    }
