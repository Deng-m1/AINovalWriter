  ...
  Future<Scene> updateSceneContentWithHistory(
    ...
    if (AppConfig.shouldUseMockData) {
      try {
        ...
        AppLogger.e('Services/api_service/repositories/impl/novel_repository_impl', 'mock更新场景内容并保存历史版本失败', e);
    ...
    try {
      ...
      AppLogger.e('Services/api_service/repositories/impl/novel_repository_impl', '更新场景内容并保存历史版本失败', e);
