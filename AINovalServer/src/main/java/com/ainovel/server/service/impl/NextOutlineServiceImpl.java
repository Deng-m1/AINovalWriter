...
public class NextOutlineServiceImpl implements NextOutlineService {
    ...
    @Autowired
    public NextOutlineServiceImpl(NovelAIService novelAIService, NextOutlineRepository nextOutlineRepository, ObjectMapper objectMapper, PromptService promptService) {
