...
import com.ainovel.server.web.dto.NovelUpdateDto;
...
public class NovelController extends ReactiveBaseController {
     ...
     */
    @PostMapping("/update")
    public Mono<Novel> updateNovel(@RequestBody NovelUpdateDto novelUpdateDto) {
        return novelService.updateNovel(novelUpdateDto.getId(), novelUpdateDto.getNovel());
    }
     ...
     * @return 场景列表
     */
    @PostMapping("/get-chapter-scenes")
    public Flux<Scene> getChapterScenes(@RequestBody NovelChapterDto novelChapterDto) {
